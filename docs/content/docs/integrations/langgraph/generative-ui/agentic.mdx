...
<Steps>
  ...
  <Step>
    ### Render state of the agent
    Now we can use the `useAgent` hook to access and render the state of our agent.
    ...
    function YourMainContent() {
      ...
      const { agent } = useAgent({
        agentId: "sample_agent", // the name the agent is served as
      });
  ...
  <Step>
    ...
    You can also render the state of your agent **outside of the chat**. The `useAgent` hook works anywhere in your app.
