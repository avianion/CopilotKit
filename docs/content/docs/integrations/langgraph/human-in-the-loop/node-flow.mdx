...
<Callout type="error">
    ...
    As of LangGraph 0.2.57, the recommended way to set breakpoints is using [the interrupt function](https://docs.copilotkit.ai/langgraph/human-in-the-loop/interrupt-flow) as it simplifies human-in-the-loop patterns.
</Callout>
