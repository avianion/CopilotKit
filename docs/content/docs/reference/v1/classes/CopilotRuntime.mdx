...
<Callout type="info">
  This is the reference for the `CopilotRuntime` class. For more information and example code snippets, please see [Copilot Runtime](/builtin-agent/copilot-runtime).
</Callout>
